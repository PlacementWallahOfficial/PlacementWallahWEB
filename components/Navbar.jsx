...
// import PWLogo from '../public/assets/PWLogo.png'
      ...
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16 dark:bg-[#28282B]">
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden md:flex">
            <li className="ml-10 text-md uppercase hover:text-[#00E676] transition duration-100 hover:delay-75 ease-in-out dark:text-teal-300 dark:hover:text-[#ffffff]">
              <Link href="/">Home</Link>
            </li>
            <li className="ml-10 text-md uppercase hover:text-[#00E676] transition duration-100 hover:delay-75 ease-in-out dark:text-teal-300 dark:hover:text-[#ffffff]">
        ...
        <div
          className={
            nav
              ...
              : "fixed left-[-150%] top-0 p-10 ease-in duration-500 dark:bg-[#28282B]"
          }
        >
          <div>
